...
namespace occiwrapper
{
	...
	public:
		...
		*/
		StatementImpl( oracle::occi::Statement* pOcciStat, shared_ptr< Connection >& pConn, bool bAutoCommit, const string& strTag ="", bool bHasCursor = false);
		...
		*/
		...
		void Add(const T& t)
		{
			...
			strStream << t;
			if (m_strStream.str() != strStream.str())
			{
				m_bNewSQL = true;
			}
			else
	...
	private:
		...
		*/
		...
		bool GetTableProperty(const string& strTableName, map<UInt8, string>& mapTablePro);
