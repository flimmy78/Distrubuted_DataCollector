...
namespace occiwrapper
{
	...
	*/
	...
	public:
		...
		*/
		shared_ptr< occiwrapper::Connection > CreateConnect( const ConnectionInfo& connInfo, bool bAutoCommit = true);

		SessionFactory( string strCharset = "", string strNCharset = "" , UInt8 nType = 0 );
		~SessionFactory();
	private:
