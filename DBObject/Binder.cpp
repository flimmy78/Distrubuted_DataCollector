...
/***
*	@brief: binds OCCICURSOR.
*/
void occiwrapper::Binder::Bind(std::size_t nPos)
{
	try
	{
		if (this->IsOut())
		{
			m_pOcciStat->registerOutParam(nPos, oracle::occi::OCCICURSOR);
		}
	}
	catch (oracle::occi::SQLException& exc)
	{
...
/***
*	@brief: retrieve OCCICURSOR.
*/
void occiwrapper::Binder::Retrieve(std::size_t nPos)
{
}
